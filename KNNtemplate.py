...
dataset = pd.read_csv('')
X = dataset.iloc[:, ].values # Chosing which columns will be the variables
y = dataset.iloc[:, ].values # With more than one index place columns in another set of brackets
